...
const JoinOrCreateOrgModal = ({
  isOpen,
  onClose,
  onJoin,
}: JoinOrCreateOrgModalProps) => {
      ...
      {mode === "create" && (
        <div className={styles.createWrapper}>
            ...
            <div className={styles.createStep}>
              ...
              <div className={formStyles.formGroup}>
                ...
                <div className={styles.typeCardRow}>
                  <button
                    ...
                    onClick={() =>
                      setOrgForm({ ...orgForm, visibility: "public" })
                    }
                  >
                    <Globe size={20} />
                  ...
                  <button
                    ...
                    onClick={() =>
                      setOrgForm({ ...orgForm, visibility: "private" })
                    }
                  >
                    <Lock size={20} />
                    <div className={styles.typeCardText}>
              ...
              <div className={formStyles.formGroup}>
                <div className={styles.requireApprovalRow}>
                  <div>
                    <label className={styles.requireApprovalLabel}>
                      {t("onboarding.requireApproval")}
                    </label>
                    <p className={styles.requireApprovalDesc}>
                  ...
                  <Toggle
                    ...
                    onToggle={(isOn) =>
                      setOrgForm({ ...orgForm, requireApproval: isOn })
                    }
                  />
                </div>
              </div>
              ...
              <div className={styles.stepActions}>
                <Button
                  variant="secondary"
                  className={styles.btnFlex1}
                  onClick={() => setMode("choice")}
                >
                  {t("common.cancel")}
                </Button>
                <Button
                  className={styles.btnFlex2}
          ...
          {createStep === 2 && (
            <div className={styles.createStep}>
              <div>
                <h4 className={styles.tierHeader}>
                  {t("onboarding.selectTier")}
                </h4>
                <p className={styles.tierTrialNote}>
                ...
                <div className={styles.tierList}>
                  ...
                  <div className={styles.summaryRow}>
                    ...
                    <span className={styles.summaryValue}>
                      {t(`onboarding.${orgForm.visibility}`)}
                    </span>
                  </div>
                  <div className={styles.summaryRow}>
                    <span className={styles.summaryLabel}>
                    ...
                    <span className={styles.summaryValue}>
                      {tiers.find((t) => t.id === orgForm.plan)?.name}
                    </span>
                  </div>
                </div>
              </div>
