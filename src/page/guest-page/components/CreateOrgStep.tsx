  ...
  return (
    <>
      <div className={wizardStyles.stepHeader}>
        <h3 className={wizardStyles.stepTitle}>
          ...
          <div className={wizardStyles.fieldGroup}>
            <div className={wizardStyles.requireApprovalRow}>
              <div>
                ...
                <p className={wizardStyles.requireApprovalDesc}>
          ...
          <div className={styles.tierList}>
            {tiers.map((tier) => (
              <button
                ...
                onClick={() =>
                  !tier.disabled && setForm({ ...form, plan: tier.id })
                }
          ...
          <div className={styles.summarySection}>
            ...
            <div className={styles.tierList}>
              ...
              <div className={styles.summaryRow}>
                ...
                <span className={styles.summaryValue}>
                  {tiers.find((t) => t.id === form.plan)?.name}
                </span>
              </div>
            </div>
          </div>
